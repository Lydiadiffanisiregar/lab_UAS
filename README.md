...
![output-tambah-data](foto/Tambah.PNG)


Ubah data

![output-ubah-data](foto/Ubah.PNG)


Lihat data

![output-lihat-data](foto/Lihat.PNG)


Cari data

![output-cari-data](foto/Cari.PNG)


Hapus data

![output-hapus-data](foto/Hapus.PNG)
